    ...
    return (
        <div>
            ...
            <p style={{ fontSize: '1.2rem', color: 'black', margin: '20px'}}>
                ...
                includes some default well-known sequences with visualizations as well. The Primer Page tab shows 
                the primers for different sequences. 
            </p>
            <p style={{ fontSize: '1.2rem', color: 'black', margin: '20px'}}>
                Usage Instructions: 
            </p>
            <ul style={{ fontSize: '1.2rem', color: 'black', margin: '20px'}}>
                <li>* Start by selecting a sequence type (DNA/RNA).</li>
