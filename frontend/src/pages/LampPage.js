...
import LampPrimerInput from "../forms/LampPrimerSequenceInputForm";
...
function LampPage() {
    ...
    function ChooseForm(){
        ...
        return (
            <div>
                <LampPrimerInput onValueChange={handleValueChange} handleSequence = {handleInputtedSequence}/>
            </div>
        );
        } else if (submitted === 2){
            return (
    ...
    return (
        <div>
            <p style={{ fontSize: '1.2rem', color: 'black', margin: '20px'}}>
                <div style = {{backgroundColor: "white", padding: '2%', height: '75vh', overflow: "visible", borderRadius: '1%'}}>
                    <ChooseForm/>
                </div>
            </p>
        </div>
