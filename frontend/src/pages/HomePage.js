...
function HomePage() {
    return (
        <div>
            ...
            <p style={{ fontSize: '1.3rem', color: 'black', marginLeft: '8vw', marginRight: '10vw'}}>
            ...
            <ul style={{ fontSize: '1.3rem', color: 'black', marginLeft: '8vw', marginRight: '10vw', marginBottom: '50px'}}>
            ...
            <button style={{ fontSize: '1.5rem', width: '26vw', height: '15vw', color: 'black', marginLeft: '8vw', marginRight: '1vw', paddingTop: '150px', paddingBottom: '150px', paddingLeft: '150px', paddingRight: '150px'}}>
                Visual Page
            </button>
            <button style={{ fontSize: '1.5rem', width: '26vw', height: '15vw',color: 'black', marginLeft: '1vw', marginRight: '1vw', paddingTop: '150px', paddingBottom: '150px', paddingLeft: '150px', paddingRight: '150px'}}>
                Primer Page
            </button>
            <button style={{ fontSize: '1.5rem', width: '26vw', height: '15vw',color: 'black', marginLeft: '1vw', paddingTop: '150px', paddingBottom: '150px', paddingLeft: '150px', paddingRight: '150px'}}>
                Primer Editor
            </button>
        </div>
    );
